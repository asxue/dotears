...
METHODS = ['dotears', 'notears', 'sortnregress', 'golem-ev', 
           'golem-nv', 'direct-lingam', 'gies', 'igsp', 
           'ut-igsp', 'dcdi-g']
# METHODS = ['dcdi-g']
# METHODS = ['dotears_obsonly']
METHODS = ['colide-nv']
...
rule all:
    input:
        ...
        #        dag_model=dag_models, experiment=experiments, method=METHODS, 
        ...
        #        dag_model=dag_models, pi=parental_influences, method=METHODS, 
        #        sim=range(std_config['n_sims'])
        #       ),
        # expand('data/dcdi_sims/out/{experiment}/{method}/sim_{sim}.npy',
        #       experiment=dcdi_experiments, method=METHODS, sim=range(1, 6)),
